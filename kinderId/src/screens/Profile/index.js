      ...
      <MyStatusBar backgroundColor="white"/>
          ...
          <ScrollView>
            ...
            <View style={styles.inputView}>
              <TextInput placeholder='John Smith' style={styles.textInput} />  
            </View>
            <View style={styles.marginSecondView}>
              <Text style={styles.codeText}>TIF.number with country code</Text> 
            </View>
            <View style={styles.inputView}>
              <TextInput placeholder='(+47) 000 00 000' keyboardType='phone-pad' style={styles.textInput} />  
            </View>
            <View style={styles.marginSecondView}>
              <Text style={styles.codeText}>E-mail address</Text> 
            </View>
            <View style={styles.inputView}>
              <TextInput placeholder='john@smith.com' style={styles.textInput} />  
            </View>
